...
resp = client.schema_service.write_schema(
  ...
  <TabItem value="node">
<SampleCodeBlock lang="ts">{`import { v1 } from '@authzed/authzed-node';
·
...
console.log(beatriceCanWrite.permissionship === v1.CheckPermissionResponse_Permissionship.HAS_PERMISSION);`}</SampleCodeBlock>
  </TabItem>
</Tabs>
