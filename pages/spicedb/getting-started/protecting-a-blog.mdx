...
Scroll all the way to the bottom of this page for a video walkthrough of creating a Permissions System using AuthZed Cloud.
...
[Authzed Cloud]: https://app.authzed.cloud/
...
- Give it a name
- Choose a datastore.
Currently only CockroachDB is supported as a datastore for a PS on AuthZed Cloud
...
Click on the Tokens item in the menu and Create token by providing a name and description.
