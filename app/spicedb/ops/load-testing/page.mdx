---
title: "Load Testing SpiceDB"
description: "Build realistic SpiceDB load tests: seed representative relationship data, distribute checks and lookups, and generate load with Thumper."
---
...
<br />
<InlinePlayground reference="InFMt9UMVzW8" />
...
<Callout type="info">
  **Info:** If you're struggling or want help, [reach out to the Authzed team][reach out] or [the
