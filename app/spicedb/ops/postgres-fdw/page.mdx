---
title: "Using Postgres FDW with SpiceDB"
description: "Query SpiceDB permissions, relationships, and schema with standard SQL using the experimental Postgres Foreign Data Wrapper proxy."
---
