...
description: "How SpiceDB exposes Prometheus metrics, pprof profiling, OpenTelemetry tracing, structured logging, audit logs, and telemetry."
---
...
A [Grafana dashboard][grafana-dashboard] is available for visualizing these metrics.

[command]: /spicedb/concepts/commands
[prom-endpoint]: https://prometheus.io/docs/concepts/jobs_instances/
[grafana-dashboard]: https://github.com/authzed/examples/blob/main/authzed-dedicated-metrics/prometheus-grafana/grafana/dashboards/spicedb_grafana_dash.json
