---
title: "Validation, Testing, Debugging SpiceDB Schemas"
description: "Tools for validating and debugging SpiceDB schemas: assertions, expected relations, check tracing, zed validate, explain and debug flags, and GitHub Actions."
---
