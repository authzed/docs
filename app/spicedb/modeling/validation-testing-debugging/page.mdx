...
To support this, SpiceDB's v1 CheckPermission API supports a debug flag that will cause SpiceDB to trace the full set of relations and permission traversed while computing the check.
