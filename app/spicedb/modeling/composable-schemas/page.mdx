...
description: "Modularize SpiceDB schemas across files with zed schema compile using import statements, partial declarations, and partial references."
---
...
A full list of reserved keywords can be found in [`keywords` map definition](https://github.com/authzed/spicedb/blob/main/pkg/schemadsl/lexer/lex_def.go#L74) in the lexer.
