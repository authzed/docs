...
description: "Step-by-step guide to building a SpiceDB schema: defining object types, relations, permissions, inherited permissions, and validating with assertions."
---
...
<Callout type="info">
  **Info:** It is _recommended_ that the right side of all arrows refer to **permissions**, instead
