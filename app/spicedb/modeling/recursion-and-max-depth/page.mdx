---
title: "Cyclical Relationships and Traversal Limits"
description: "How SpiceDB traverses the permissions tree, the dispatch-max-depth limit, why cycles cause max depth errors, and how to detect and break them with zed."
---
