...
description: "Build access-control management UIs with SpiceDB APIs to list and modify role assignments for coarse-grained and fine-grained (custom role) models."
---
