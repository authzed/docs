---
title: "Access Control in RAG with Pinecone and SpiceDB"
description: "Add fine-grained authorization to Pinecone RAG pipelines with SpiceDB using pre-filter (LookupResources) and post-filter (CheckBulkPermissions) strategies."
---
