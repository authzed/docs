---
title: "Testing RAG Pipelines with Testcontainers and SpiceDB"
description: "Write isolated integration tests for permission-aware RAG pipelines by spinning up throwaway SpiceDB instances with Testcontainers in Python and Go."
---
...
The SpiceDB Testcontainer is available in [Python](https://testcontainers.com/modules/spicedb/?language=python) and [Go](https://testcontainers.com/modules/spicedb/?language=go). This guide shows how you can use the Python module.  
