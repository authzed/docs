---
title: "Building Agentic RAG with SpiceDB, LangChain & Weaviate"
description: "Add a non-bypassable authorization step to an agentic RAG pipeline using SpiceDB, LangGraph, and Weaviate, with batch permission checks and fail-closed security."
---
