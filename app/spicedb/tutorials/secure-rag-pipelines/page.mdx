---
title: "Secure Your RAG Pipelines With Fine Grained Authorization"
description: "Use SpiceDB to pre-filter and post-filter vector database queries with authorized object IDs, demonstrated with OpenAI, Pinecone, LangChain, and Jupyter."
---
