...
The `spicedb-dev` plugin teaches your agent how to design a permission model, generate a schema, write the relationship and permission-check code, audit coverage as your app grows, generate tests, and migrate an existing authorization solution (OpenFGA, Okta FGA, etc.) onto SpiceDB.
...
If you already run an existing authorization solution (OpenFGA, Okta FGA, etc.):
