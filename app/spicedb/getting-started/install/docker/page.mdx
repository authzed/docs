---
title: "Installing SpiceDB with Docker"
description: "How to install SpiceDB via Docker: pulling images from Docker Hub, GHCR, and Quay, plus using the debug images for troubleshooting."
---
