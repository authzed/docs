---
title: "Installing SpiceDB on RHEL or CentOS"
description: "How to install SpiceDB on RPM-based Linux distributions using dnf with the AuthZed yum repository, or via a manual binary download."
---
