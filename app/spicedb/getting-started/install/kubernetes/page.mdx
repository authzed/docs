---
title: "Installing SpiceDB on Kubernetes"
description: "How to deploy SpiceDB on Kubernetes using the SpiceDB Operator, raw kubectl manifests, or a community-maintained Helm chart."
---
