...
Snapshots underpin both Materialize features: they're what Materialize hydrates in order to answer Accelerated Queries, and they're what make the Event Streams APIs compose safely:
