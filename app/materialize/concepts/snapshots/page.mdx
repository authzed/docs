...
<Callout type="warning">
  After a breaking schema change you **must** pass the revision token through
  `optional_starting_after` when re-hydrating, or Materialize will stream against whatever snapshot
  is current and your data won't reflect the schema change.
</Callout>
